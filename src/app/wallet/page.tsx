  ...
  if (checkingAuth) {
    return (
      <div className="mx-auto flex min-h-[60vh] max-w-4xl items-center justify-center px-4 py-16">
        <div className="flex flex-col items-center gap-3 text-xs text-[#80766b]">
          <div className="size-8 animate-spin rounded-full border-2 border-[#7d1d29] border-t-transparent" />
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 lg:py-12 dir-rtl font-cairo">
      ...
      <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs text-[#80766b]">
        <Link href="/" className="hover:text-[#7d1d29] transition">
          الرئيسية
        </Link>
        <span className="text-[#ede5da]">/</span>
        <span className="font-bold text-[#1e1b18]">المحفظة الإلكترونية</span>
      </nav>

      {/* ─── Hero Coming Soon Card ─── */}
      <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[#4a0815] via-[#7d1d29] to-[#200509] p-8 text-white shadow-2xl shadow-[#7d1d29]/20 sm:p-12 md:p-16">
        {/* Subtle decorative background circles */}
        <div className="pointer-events-none absolute -left-20 -top-20 size-72 rounded-full bg-[#c48b4e]/15 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-20 -right-20 size-72 rounded-full bg-white/10 blur-3xl" />

        <div className="relative z-10 flex flex-col items-center text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-bold text-[#fbf4ea] backdrop-blur-md">
          ...
          <div className="relative mt-8">
            <div className="grid size-24 place-items-center rounded-[2rem] border border-white/20 bg-white/15 text-white shadow-xl backdrop-blur-md sm:size-28">
              <WalletIcon className="size-12 text-[#fbf4ea] sm:size-14" />
            </div>
            <span className="absolute -bottom-2 -right-2 grid size-8 place-items-center rounded-full bg-[#c48b4e] text-white shadow-md">
          ...
          <p className="mt-3 max-w-xl text-sm sm:text-base text-[#fbf4ea]/85 leading-relaxed">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            <Link
              href="/products"
              className="flex items-center gap-2 rounded-2xl bg-white px-6 py-3.5 text-xs font-black text-[#7d1d29] shadow-lg transition duration-200 hover:bg-[#fff9f8] hover:scale-102 active:scale-98"
            >
      ...
      <div className="mt-12">
        <div className="mb-6 text-center sm:text-right">
          <h2 className="text-lg font-black text-[#1e1b18] sm:text-xl">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {/* Card 1 */}
          <div className="flex flex-col gap-3 rounded-3xl border border-[#ede5da] bg-white p-6 shadow-2xs transition hover:border-[#7d1d29]/30 hover:shadow-md">
            <div className="grid size-12 place-items-center rounded-2xl bg-[#fdf0f2] text-[#7d1d29]">
              <Zap className="size-6" />
            </div>
            <h3 className="text-sm font-black text-[#1e1b18]">دفع فوري بضغطة واحدة</h3>
          ...
          <div className="flex flex-col gap-3 rounded-3xl border border-[#ede5da] bg-white p-6 shadow-2xs transition hover:border-[#7d1d29]/30 hover:shadow-md">
            ...
            <h3 className="text-sm font-black text-[#1e1b18]">خيارات شحن مرنة ومتعددة</h3>
            <p className="text-xs text-[#80766b] leading-relaxed">
          ...
          <div className="flex flex-col gap-3 rounded-3xl border border-[#ede5da] bg-white p-6 shadow-2xs transition hover:border-[#7d1d29]/30 hover:shadow-md">
            ...
            <h3 className="text-sm font-black text-[#1e1b18]">كاش باك وعروض حصرية</h3>
            <p className="text-xs text-[#80766b] leading-relaxed">
          ...
          <div className="flex flex-col gap-3 rounded-3xl border border-[#ede5da] bg-white p-6 shadow-2xs transition hover:border-[#7d1d29]/30 hover:shadow-md">
            ...
            <h3 className="text-sm font-black text-[#1e1b18]">حماية وأمان معتمد</h3>
            <p className="text-xs text-[#80766b] leading-relaxed">
          ...
          <div className="flex flex-col gap-3 rounded-3xl border border-[#ede5da] bg-white p-6 shadow-2xs transition hover:border-[#7d1d29]/30 hover:shadow-md">
            ...
            <h3 className="text-sm font-black text-[#1e1b18]">استرجاع فوري للمبالغ</h3>
            <p className="text-xs text-[#80766b] leading-relaxed">
          ...
          <div className="flex flex-col gap-3 rounded-3xl border border-[#ede5da] bg-white p-6 shadow-2xs transition hover:border-[#7d1d29]/30 hover:shadow-md">
            ...
            <h3 className="text-sm font-black text-[#1e1b18]">تحويل الرصيد والمشاركة</h3>
            <p className="text-xs text-[#80766b] leading-relaxed">
